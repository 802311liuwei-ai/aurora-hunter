...
const routes = [
  ...
  "/guide/murmansk-aurora-best-month",
  "/guide/murmansk-aurora-how-many-days",
  "/guide/murmansk-aurora-cost",
  "/guide/murmansk-free-travel-safe",
  "/guide/teriberka-one-day-trip",
  "/guide/russia-aurora-vs-nordic",
  "/guide/murmansk-family-itinerary",
  "/guide/murmansk-cash-sim-card",
...
for (const guide of [
  ...
  ["murmansk-aurora-best-month", "摩尔曼斯克极光几月最好"],
  ["murmansk-aurora-how-many-days", "摩尔曼斯克极光旅游几天合适"],
  ["murmansk-aurora-cost", "摩尔曼斯克极光旅游多少钱"],
  ["murmansk-free-travel-safe", "摩尔曼斯克自由行安全吗"],
  ["teriberka-one-day-trip", "捷里别尔卡一日游攻略"],
  ["russia-aurora-vs-nordic", "俄罗斯极光和北欧极光怎么选"],
  ["murmansk-family-itinerary", "带孩子去摩尔曼斯克怎么玩"],
  ["murmansk-cash-sim-card", "去摩尔曼斯克需要带现金和电话卡吗"],
]) {
