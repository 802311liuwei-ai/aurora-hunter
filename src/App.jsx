...
const guides = [
  ...
  {
    id: "murmansk-aurora-best-month", title: "摩尔曼斯克极光几月最好？", read: "7分钟", image: "/images/hero-aurora.png",
    label: "月份选择", topics: ["9月下旬", "12月至2月", "3月追光", "避坑建议"],
    intro: "很多人搜索的第一个问题就是：摩尔曼斯克极光几月最好？答案不是单一月份，而是看你更在意雪景、体感、白天活动还是请假成本。",
    sections: [
      ["先看结论", ["如果只看追光条件，9月下旬至3月底都值得规划；如果想要深冬雪景和北极氛围，12月至2月更强烈；如果想兼顾白天活动和相对舒适体感，3月通常更均衡。", "不建议把‘最好月份’理解为保证看到极光。极光需要黑夜、太阳活动和无云天空共同配合，任何月份都不能百分之百保证。"]],
      ["9月至10月适合谁", ["适合不想承受极寒、又希望看到季初极光的游客。苔原仍可能有秋色，湖面未完全封冻时有机会拍到倒影。", "短板是雨、云和季节转换较快，画面未必有厚雪氛围。"]],
      ["12月至2月适合谁", ["适合想要极夜、雪原、驯鹿、哈士奇和浓烈北境感的游客。夜长给追光留下更多时间窗口。", "短板是低温和风雪更考验装备，热门日期也更容易出现车辆、酒店和房价压力。"]],
      ["3月为什么很推荐", ["3月夜晚仍有追光条件，白天变长，安排捷里别尔卡、城市、雪地项目会更舒服。", "对第一次去摩尔曼斯克的中国游客来说，3月往往是‘追光概率、白天体验、体感舒适度’之间比较平衡的选择。"]],
    ],
  },
  {
    id: "murmansk-aurora-how-many-days", title: "摩尔曼斯克极光旅游几天合适？", read: "7分钟", image: "/images/aurora-village.png",
    label: "停留天数", topics: ["3晚起步", "4天3晚", "5天4晚", "不要压缩"],
    intro: "只停一晚追极光，风险很高。摩尔曼斯克极光旅游更建议按‘至少3个夜间窗口’规划，再把白天体验组合进去。",
    sections: [
      ["为什么至少住3晚", ["极光最大的不确定不是地点，而是当晚天空是否打开。连续3晚能把云层、降雪和道路变化的风险分散开。", "如果只安排一晚，遇到厚云或暴风雪就很容易全程落空；如果把唯一追光夜放在离境前一晚，还会受到航班和休息时间限制。"]],
      ["4天3晚适合第一次去", ["4天3晚可以放入接机、摩尔曼斯克城市、捷里别尔卡、萨米文化或冰上漂浮，并保留多个夜间追光窗口。", "这是时间有限、又希望完整体验北境冬季的游客最常见选择。"]],
      ["5天4晚适合谁", ["如果你很在意极光照片、带孩子或老人、想要行程更松，5天4晚会更舒服。", "多一晚不仅是多一次追光机会，也能给天气取消、道路调整和身体恢复留出空间。"]],
      ["不建议这样排", ["不要当天抵达就接很满的白天项目再夜间追光；长途飞行后体力消耗很大。", "不要把捷里别尔卡出海、夜间追光和次日早班机连在一起，北境旅行需要给天气和睡眠留余地。"]],
    ],
  },
  {
    id: "murmansk-aurora-cost", title: "摩尔曼斯克极光旅游多少钱？", read: "8分钟", image: "/images/reindeer-winter.png",
    label: "费用预算", topics: ["机票酒店", "追光团", "包车私团", "隐性成本"],
    intro: "摩尔曼斯克极光旅游费用差异很大，取决于季节、人数、酒店、车辆、是否私人团、是否包含白天项目和合同接待标准。",
    sections: [
      ["费用主要由什么组成", ["常见费用包括国际与俄罗斯国内交通、摩尔曼斯克酒店、机场接送、夜间追光、捷里别尔卡、萨米村、雪地或出海项目、餐食、保险和签证相关成本。", "同样写着‘4天3晚’，包含项目、车辆人数、酒店等级和是否私人接待不同，价格会差很多。"]],
      ["为什么旺季更贵", ["12月底至春节前后，中国游客出行集中，酒店、车辆和向导资源都更紧张。", "如果目标是圣诞、新年或寒假，请尽量提前确认，不要用淡季价格预估旺季成本。"]],
      ["省钱可以省在哪里", ["可以选择市区普通酒店、小团、少量自理餐食，或把部分白天项目改为城市自由活动。", "不建议省掉保暖装备、旅行保险和必要接送。北极圈旅行里，舒适和安全比表面低价更重要。"]],
      ["询价时要问清楚", ["确认合同主体、包含项目、未包含费用、取消规则、是否含接送、是否含拍照、是否需要额外支付门票或装备。", "Aurora Hunter 提供中文咨询与沟通协助，具体旅游产品和收款由合作的俄罗斯持牌旅行社确认。"]],
    ],
  },
  {
    id: "murmansk-free-travel-safe", title: "摩尔曼斯克自由行安全吗？", read: "8分钟", image: "/images/murmansk-city-aerial.jpg",
    label: "自由行安全", topics: ["语言沟通", "夜间追光", "冬季道路", "应急准备"],
    intro: "摩尔曼斯克市区自由行并不神秘，但夜间追光、冬季道路、低温和语言沟通会明显提高旅行难度。安全与否取决于你怎么安排。",
    sections: [
      ["市区自由活动相对简单", ["摩尔曼斯克市区有酒店、餐厅、超市和出租车服务，白天参观城市地标相对容易。", "建议提前保存酒店地址、地图、翻译软件、保险电话和接待方联系方式；不要完全依赖临时网络。"]],
      ["夜间追光不建议纯自驾尝试", ["冬季郊外道路、积雪、黑冰、无信号区域和低温等待都会增加风险。", "如果不熟悉俄语、当地道路和车辆救援方式，不建议自己租车夜间追光。更稳妥的方式是由熟悉道路的当地团队执行。"]],
      ["捷里别尔卡也需要弹性", ["冬季前往捷里别尔卡可能遇到封路、强风和临时调整。导航显示能到，不代表当天适合游客自行前往。", "如果遇到天气变化，应以当地道路信息和接待方判断为准，不要为了打卡强行出发。"]],
      ["自由行也要准备这些", ["护照和签证备份、卢布现金、电话卡或漫游、旅行保险、保暖装备、常用药和紧急联系人。", "对第一次来北极圈的游客，建议把白天城市自由活动和夜间/远郊当地接待结合起来。"]],
    ],
  },
  {
    id: "teriberka-one-day-trip", title: "捷里别尔卡一日游攻略", read: "8分钟", image: "/images/teriberka-coast.png",
    label: "北冰洋一日", topics: ["一日路线", "冬季封路", "龙蛋海滩", "出海观鲸"],
    intro: "捷里别尔卡一日游是摩尔曼斯克最常见的白天行程之一。它看似简单，其实受道路、风雪、海况和季节影响很大。",
    sections: [
      ["一天通常怎样安排", ["从摩尔曼斯克出发，穿越苔原公路抵达捷里别尔卡，常见停靠包括旧渔村、船舶墓地、海岸岩石、瀑布或龙蛋海滩一带。", "具体停靠顺序会根据天气、道路、风力和团队情况调整，不建议把每个点都排得太满。"]],
      ["冬季最大变量是道路", ["冬季公路可能因风雪临时关闭，也可能需要等待清雪或改期。", "如果当天无法安全前往，应接受调整；北冰洋海岸不是普通城市景点，安全优先。"]],
      ["夏季可以加出海吗", ["5月至9月可根据海况尝试安排巴伦支海出海寻找鲸类和海鸟，但鲸类为野生动物，无法保证出现。", "出海是否执行由风浪、港口和船方判断决定，建议预留可调整时间。"]],
      ["穿什么带什么", ["冬季重点是防风、防雪、雪地靴和手套；夏季也需要防风外套，因为海边风冷明显。", "带好水、零食、晕车或晕船准备、充电宝和护照信息备份。"]],
    ],
  },
  {
    id: "russia-aurora-vs-nordic", title: "俄罗斯极光和北欧极光怎么选？", read: "8分钟", image: "/images/hero-aurora.png",
    label: "目的地对比", topics: ["预算差异", "旅行氛围", "中文服务", "适合人群"],
    intro: "想看极光，很多人会在俄罗斯摩尔曼斯克、芬兰、挪威、冰岛之间犹豫。目的地没有绝对高低，关键看预算、签证、旅行风格和同行人。",
    sections: [
      ["摩尔曼斯克适合谁", ["适合希望用较高性价比体验北极圈、极光、北冰洋海岸和俄罗斯城市氛围的游客。", "它的旅行感更偏真实北方城市和荒野海岸，不是精致度假村式体验。"]],
      ["北欧适合谁", ["芬兰、挪威、冰岛在酒店、公共交通、度假体验和英语环境上通常更成熟，但整体预算也往往更高。", "如果你更看重设计型住宿、成熟度假设施或自驾环线，北欧可能更符合期待。"]],
      ["极光概率怎么比较", ["只用国家比较概率并不准确。极光取决于纬度、云量、黑夜、太阳活动和停留晚数。", "摩尔曼斯克位于极光带内，具备追光条件；但云层和天气仍然是关键变量。"]],
      ["中国游客要考虑什么", ["俄罗斯需要重点考虑签证、支付、语言和当地接待；北欧则要考虑预算、签证材料和旺季房价。", "如果你希望有人协助中文沟通、解释行程和对接当地旅行社，摩尔曼斯克会是更务实的选择之一。"]],
    ],
  },
  {
    id: "murmansk-family-itinerary", title: "带孩子去摩尔曼斯克怎么玩？", read: "8分钟", image: "/images/husky-sled.png",
    label: "亲子行程", topics: ["适合年龄", "哈士奇驯鹿", "节奏安排", "夜间追光"],
    intro: "亲子追光不是把成人行程原样缩小。孩子的年龄、作息、耐寒和车程适应能力，会直接影响摩尔曼斯克旅行体验。",
    sections: [
      ["更适合的年龄", ["冬季追光更建议7岁以上，8至15岁通常体验感更稳定。", "低龄儿童不是绝对不能去，但家长要接受夜间作息、低温等待和长车程带来的压力。"]],
      ["亲子最喜欢哪些体验", ["驯鹿、哈士奇、雪地活动、北冰洋海岸和城市地标通常比单纯长时间等待极光更适合孩子。", "如果孩子第一次来北极圈，可以把‘追光’作为夜间窗口，把白天体验安排得更丰富。"]],
      ["节奏不要排满", ["亲子家庭建议选择更松的4天3晚或5天4晚，给休息、天气调整和临时不适留空间。", "不要连续安排长车程、夜间追光和很早出发的白天项目。"]],
      ["家长必须准备", ["儿童保暖装备、备用手套袜子、常用药、保温杯、零食、旅行保险和孩子健康情况说明。", "夜间可先在车内等待，出现极光窗口后短时间下车观看，不要让孩子长时间站在风口。"]],
    ],
  },
  {
    id: "murmansk-cash-sim-card", title: "去摩尔曼斯克需要带现金和电话卡吗？", read: "7分钟", image: "/images/murmansk-city-aerial.jpg",
    label: "支付通讯", topics: ["卢布现金", "银联卡", "电话卡", "离线地图"],
    intro: "第一次去俄罗斯北极圈，很多中国游客会卡在支付和网络上。提前准备现金、通讯和离线资料，会让摩尔曼斯克旅行轻松很多。",
    sections: [
      ["现金仍然重要", ["建议准备一定数量卢布现金，用于餐饮、小费、临时交通、超市和网络不稳定时的备用支付。", "不要把所有现金放在一个位置，护照、银行卡和现金也不要全部集中在同一个包里。"]],
      ["银行卡能不能用", ["不要完全依赖境外发行的Visa或Mastercard。银联可以作为备用，但受理范围和终端状态不固定。", "大额旅游服务应以合同约定的收款方式为准，付款前确认主体、金额、包含项目和退改规则。"]],
      ["电话卡和漫游怎么选", ["可以提前开通国际漫游，或抵达后使用俄罗斯电话卡。常见运营商包括MTS、MegaFon等，具体资费和覆盖会变化。", "eSIM是否可用取决于手机型号和供应商，出发前要确认。"]],
      ["离线资料一定要存", ["提前下载离线地图、翻译软件、酒店地址、保险单、护照签证照片和接待方联系方式。", "北境郊外网络不一定稳定，追光或前往捷里别尔卡时不要把所有信息都放在线上。"]],
    ],
  },
];

const featuredGuideIds = ["aurora-calendar", "teriberka-whale-calendar", "china-traveler-faq-20", "murmansk-aurora-best-month", "murmansk-aurora-how-many-days", "murmansk-aurora-cost", "murmansk-free-travel-safe", "teriberka-one-day-trip", "russia-aurora-vs-nordic", "murmansk-family-itinerary", "murmansk-cash-sim-card"];
...
const seoPages = {
  ...
  "/guide/murmansk-aurora-best-month": ["摩尔曼斯克极光几月最好_月份选择攻略 | Aurora Hunter", "比较9月、10月、12月至2月和3月的摩尔曼斯克极光旅行体验，了解雪景、体感和追光窗口。"],
  "/guide/murmansk-aurora-how-many-days": ["摩尔曼斯克极光旅游几天合适_4天3晚怎么排 | Aurora Hunter", "解释摩尔曼斯克追极光为什么建议至少3晚，4天3晚和5天4晚分别适合哪些中国游客。"],
  "/guide/murmansk-aurora-cost": ["摩尔曼斯克极光旅游多少钱_费用预算与询价重点 | Aurora Hunter", "了解摩尔曼斯克极光旅游费用构成、旺季差异、小团与私团预算、合同和付款需要确认的问题。"],
  "/guide/murmansk-free-travel-safe": ["摩尔曼斯克自由行安全吗_中国游客安全攻略 | Aurora Hunter", "从市区自由活动、夜间追光、冬季道路、捷里别尔卡和应急准备判断摩尔曼斯克自由行安全性。"],
  "/guide/teriberka-one-day-trip": ["捷里别尔卡一日游攻略_摩尔曼斯克到北冰洋 | Aurora Hunter", "整理捷里别尔卡一日游路线、冬季封路、龙蛋海滩、船舶墓地、夏季出海观鲸和装备准备。"],
  "/guide/russia-aurora-vs-nordic": ["俄罗斯极光和北欧极光怎么选_摩尔曼斯克对比北欧 | Aurora Hunter", "比较俄罗斯摩尔曼斯克、芬兰、挪威和冰岛极光旅行在预算、氛围、签证、中文服务和适合人群上的差异。"],
  "/guide/murmansk-family-itinerary": ["带孩子去摩尔曼斯克怎么玩_亲子追光行程建议 | Aurora Hunter", "面向亲子家庭说明摩尔曼斯克极光旅行适合年龄、驯鹿哈士奇体验、夜间追光节奏和保暖准备。"],
  "/guide/murmansk-cash-sim-card": ["去摩尔曼斯克需要带现金和电话卡吗_支付通讯攻略 | Aurora Hunter", "说明俄罗斯摩尔曼斯克旅行的卢布现金、银联卡、电话卡、国际漫游、eSIM和离线地图准备。"],
};
