...
const contactPhone = "19700781899";
...
const socialLinks = {
  ...
  douyin: "https://www.douyin.com/search/19700781899?type=user",
};
...
function SocialContact({ type, label, href, icon, onClick, disabled = false, target }) {
  ...
  if (href && !disabled) return <a className={`social-contact social-contact--${type}`} href={href} target={target} rel={target === "_blank" ? "noreferrer" : undefined} onClick={onClick}>{content}</a>;
